  ...
  return (
    <div className='navbar glass-panel'>
      ...
      <div className="navbar-right">
        <div className="navbar-icon notification-bell">
        ...
        <div className="navbar-icon navbar-profile">
            <svg className='profile-avatar' viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
